        ...
        stage('Build Docker Image') {
            steps {
                sshagent(credentials: ['jenkins-slave']) {
                    ...
                    sh "ssh ec2-user@ec2-34-207-48-198.compute-1.amazonaws.com 'aws ecr get-login-password --region ${} | sudo docker login --username AWS --password-stdin ${}.dkr.ecr.${}.amazonaws.com/${}'"
