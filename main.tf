...
data "aws_vpc" "existing" {
  id = aws_vpc.main.id  # Replace "vpc-XXXXXXXXXXXXXXXXX" with your VPC ID
}
...
resource "aws_ecs_task_definition" "task_definition" {
  ...
  execution_role_arn    = "arn:aws:iam::584934534486:role/ecsRole"  # Replace "XXX" with your IAM role ARN
...
resource "aws_ecs_service" "service" {
  ...
  network_configuration {
    subnets          = [aws_subnet.subnet.id]  # Replace "subnet-XXX" with your subnet IDs
